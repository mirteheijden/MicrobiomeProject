...
regroup_KO() {
        ...
        DB="/scratch/project_XXXX/mice_feces_IV2/DATABASE_DIR/utility_mapping/map_ko_uniref90.txt.gz"
...
regroup_eggnog() {
        ...
        DB="/scratch/project_XXXX/mice_feces_IV2/DATABASE_DIR/utility_mapping/map_eggnog_uniref90.txt.gz"
        humann_regroup_table --input "$input" --output "$output" -c $DB
}
...
regroup_GO() {
        ...
        DB="/scratch/project_XXXX/mice_feces_IV2/DATABASE_DIR/utility_mapping/map_go_uniref90.txt.gz"
         humann_regroup_table --input "$input" --output "$output" -c $DB
}
...
regroup_pfam() {
        ...
        DB="/scratch/project_XXXX/mice_feces_IV2/DATABASE_DIR/utility_mapping/map_pfam_uniref90.txt.gz"
        humann_regroup_table --input "$input" --output "$output" -c $DB
}
